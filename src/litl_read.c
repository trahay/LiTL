 ...
 */
static void __next_buffer(litl_trace_read_t* arch, litl_size_t trace_index,
        litl_size_t buffer_index) {
...
static litl_read_t* __read_event(litl_trace_read_t* arch,
        litl_size_t trace_index, litl_size_t buffer_index) {
