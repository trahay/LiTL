...
#define LITL_READ_GET_CUR_EVENT_PER_THREAD(_trace_, _thread_index_) (&(_trace_)->buffers[(_thread_index_)].cur_event)
#define LITL_READ_GET_CUR_EVENT(_trace_) LITL_READ_GET_CUR_EVENT_PER_THREAD(_trace_, (trace)->cur_index)

#define LITL_READ_GET_TID(_read_event_) (_read_event_)->tid
#define LITL_READ_GET_TIME(_read_event_) (_read_event_)->event->time
#define LITL_READ_GET_TYPE(_read_event_) (_read_event_)->event->type
#define LITL_READ_GET_CODE(_read_event_) (_read_event_)->event->code

#define LITL_READ_RAW(_read_event_) (&(_read_event_)->event->parameters.raw)
#define LITL_READ_REGULAR(_read_event_) (&(_read_event_)->event->parameters.regular)
#define LITL_READ_PACKED(_read_event_) (&(_read_event_)->event->parameters.packed)
#define LITL_READ_OFFSET(_read_event_) (&(_read_event_)->event->parameters.offset)

/*
 * Assigns the first parameter of p_evt to arg1
 */
#define litl_read_get_param_1(p_evt, arg1)		\
  do {						\
    void* _ptr_;				\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);		\
  } while(0)

/*
 * Assigns the first 2 parameters of p_evt to arg1 and arg2
 */
#define litl_read_get_param_2(p_evt, arg1, arg2)	\
  do {						\
    void* _ptr_;				\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);		\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg2);		\
  } while(0)

/*
 * Assigns the first 3 parameters of p_evt to arg1, ..., arg3
 */
#define litl_read_get_param_3(p_evt, arg1, arg2, arg3)	\
  do {							\
    void* _ptr_;					\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);				\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg2);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg3);			\
  } while(0)

/*
 * Assigns the first 4 parameters of p_evt to arg1, ..., arg4
 */
#define litl_read_get_param_4(p_evt, arg1, arg2, arg3, arg4)	\
  do {							\
    void* _ptr_;					\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);				\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg2);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg3);			\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg4);			\
  } while(0)

/*
 * Assigns the first 5 parameters of p_evt to arg1, ..., arg5
 */
#define litl_read_get_param_5(p_evt, arg1, arg2, arg3, arg4, arg5)	\
  do {								\
    void* _ptr_;						\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);				\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg3);				\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg4);				\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg5);				\
  } while(0)

/*
 * Assigns the first 6 parameters of p_evt to arg1, ..., arg6
 */
#define litl_read_get_param_6(p_evt, arg1, arg2, arg3, arg4, arg5, arg6)	\
  do {									\
    void* _ptr_;							\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);						\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);					\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg4);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg5);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg6);					\
  } while(0)

/*
 * Assigns the first 7 parameters of p_evt to arg1, ..., arg7
 */
#define litl_read_get_param_7(p_evt, arg1, arg2, arg3, arg4, arg5, arg6, arg7) \
  do {									\
    void* _ptr_;							\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);						\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);					\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg5);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg6);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg7);					\
  } while(0)

/*
 * Assigns the first 8 parameters of p_evt to arg1, ..., arg8
 */
#define litl_read_get_param_8(p_evt, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) \
  do {									\
    void* _ptr_;							\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);						\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);					\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg6);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg7);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg8);					\
  } while(0)

/*
 * Assigns the first 9 parameters of p_evt to arg1, ..., arg9
 */
#define litl_read_get_param_9(p_evt, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) \
  do {									\
    void* _ptr_;							\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);						\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);					\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg7);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg8);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg9);					\
  } while(0)

/*
 * Assigns the first 10 parameters of p_evt to arg1, ..., arg10
 */
#define litl_read_get_param_10(p_evt, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) \
  do {									\
    void* _ptr_;							\
    __LITL_READ_INIT_PTR(p_evt, _ptr_);						\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg1);					\
    ...
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg8);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg9);					\
    __LITL_READ_GET_ARG(p_evt, _ptr_, arg10);				\
  } while(0)
